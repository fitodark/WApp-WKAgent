...
def obtener_proveedor() -> ProveedorWhatsApp:
    ...
    elif proveedor == "openwa":
        from agent.providers.openwa import ProveedorOpenWA
        return ProveedorOpenWA()
    else:
        raise ValueError(f"Proveedor no soportado: {proveedor}. Usa: whapi, meta, twilio, u openwa")
